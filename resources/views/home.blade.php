    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <br>
          <a href="https://www.instagram.com/p/B2cDb2LnE0J/" target="_blank" class="btn btn-danger btn-raised btn-lg">
      ...
      <div class="col-md-8 ml-auto mr-auto">
        ...
        <div class="section text-center">
          ...
          <h5 class="description"><strong>Our Vision: </strong>Our work aims to ensure that marginalized and
            ...
            opportunities. We believe that every individual should receive basic amenities for sustenance, so they may
            go
